...
3. Need to implement a process to backup user to postgres after they've been authenticated/created in firebase.
4. Build out profile.
5. Need to work more on consolidating functions into controllers and less code duplication.
