...
Feel free to FORK me and contribute to this project.
...
1. Supports oAuth login via Facebook and Twitter
2. Admin Section
...
2. Need to implement a process to backup user to MySQL after they've been authenticated/created in firebase.
3. Need to make Contact Form
4. Add to Group Managment where Admin can see members of a Group.
